...
int main(int argc, char** argv) {
    ...
    window = SDL_CreateWindow(
        "SDL2 Examples - 05 Post Processing, Gamma Correction and HDR", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, window_width, window_height, flags);
    if (window == nullptr) {
