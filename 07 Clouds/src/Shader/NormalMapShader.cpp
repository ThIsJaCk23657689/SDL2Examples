...
const std::string NormalMapShader::VERTEX_FILE = "assets/shaders/normalmap.vert";
const std::string NormalMapShader::FRAGMENT_FILE = "assets/shaders/normalmap.frag";

NormalMapShader::NormalMapShader() : Shader(VERTEX_FILE, FRAGMENT_FILE) {}

void NormalMapShader::SetLight(const std::unique_ptr<Light>& light, const int& light_index) {
    switch (light->caster) {
